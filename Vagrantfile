...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # config.vm.network :private_network, ip: "192.128.33.10"
  ...
  config.vm.define :compute1 do |compute1_config|
   compute1_config.vm.network :private_network, type: :dhcp
  ...
  #  compute2_config.vm.network :private_network, ip: "192.168.206.130" # eth1
  #  compute2_config.vm.network :private_network, ip: "192.168.100.130" # eth2
  #  compute2_config.vm.host_name = "compute2"
  #  compute2_config.customize ["modifyvm", :id, "--nicpromisc3", "allow-all"]
  # end
